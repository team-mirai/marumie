import { serializeOtherIncomeSection } from "@/server/domain/serializers/other-income-serializer";
import type { OtherIncomeSection } from "@/server/domain/converters/other-income-converter";
