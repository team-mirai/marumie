...
export default function StatisticsTable({ statistics }: StatisticsTableProps) {
  ...
  return (
    <div className="mb-4">
      ...
      <div>
        <table className="border-collapse border border-primary-border rounded-lg overflow-hidden">
          <thead>
            <tr className="bg-primary-input">
              <th className="border border-primary-border px-4 py-2 text-left text-xs font-semibold text-white">
                状態
              </th>
              <th className="border border-primary-border px-4 py-2 text-center text-xs font-semibold text-white">
                収入
              </th>
              <th className="border border-primary-border px-4 py-2 text-center text-xs font-semibold text-white">
                支出
          ...
          <tbody>
            ...
            <tr>
              <td className="border border-primary-border px-4 py-2 text-xs text-red-500 font-medium">
                無効
              </td>
              <td className="border border-primary-border px-4 py-2 text-xs text-white text-center">
            ...
            <tr>
              <td className="border border-primary-border px-4 py-2 text-xs text-yellow-500 font-medium">
                スキップ
              </td>
              <td className="border border-primary-border px-4 py-2 text-xs text-white text-center">
