...
-- Add 'branch-grants-expenses' to allowed expense categories
-- This is required for SYUUSHI07_16 which needs counterpart info (HONSIBU_NM, JIMU_ADR)
