...
## XML仕様（docs/report_format.md より）
  ...
  <KUBUN1>  <!-- 組織活動費 -->
    <SHEET>
      ...
      <ROW>
        ...
        <ADR>住所</ADR>
        <BIKOU>備考</BIKOU>
        <RYOUSYU>領収書区分</RYOUSYU>
      </ROW>
    </SHEET>
  </KUBUN1>
  <KUBUN2><!-- 選挙関係費 --><SHEET>...</SHEET></KUBUN2>
  <KUBUN3><!-- 機関紙誌の発行事業費 --><SHEET>...</SHEET></KUBUN3>
  <KUBUN4><!-- 宣伝事業費 --><SHEET>...</SHEET></KUBUN4>
  <KUBUN5><!-- 政治資金パーティー開催事業費 --><SHEET>...</SHEET></KUBUN5>
  <KUBUN6><!-- その他の事業費 --><SHEET>...</SHEET></KUBUN6>
  <KUBUN7><!-- 調査研究費 --><SHEET>...</SHEET></KUBUN7>
  <KUBUN8><!-- 寄附・交付金 --><SHEET>...</SHEET></KUBUN8>
  <KUBUN9><!-- その他の経費 --><SHEET>...</SHEET></KUBUN9>
</SYUUSHI07_15>
```
